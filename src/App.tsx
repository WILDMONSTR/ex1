...
function App() {
  ...
  return (
    <div className="min-h-screen bg-stone-50 text-stone-800 font-sans overflow-x-hidden">
      ...
      >
        <div className="absolute top-[8%] left-1/2 -translate-x-1/2 w-64 h-64 rounded-full bg-amber-200 blur-3xl opacity-[0.45]" />
        <div className="absolute top-[42%] left-1/2 -translate-x-1/2 w-72 h-72 rounded-full bg-emerald-200 blur-3xl opacity-[0.45]" />
        <div className="absolute top-[78%] left-1/2 -translate-x-1/2 w-56 h-56 rounded-full bg-sky-200 blur-3xl opacity-[0.45]" />
      </div>
      <div
        aria-hidden="true"
        ...
        style={{ width: 'max(0px, calc((100vw - 72rem) / 2))' }}
      >
        <div className="absolute top-[14%] left-1/2 -translate-x-1/2 w-56 h-56 rounded-full bg-sky-200 blur-3xl opacity-[0.45]" />
        <div className="absolute top-[48%] left-1/2 -translate-x-1/2 w-72 h-72 rounded-full bg-amber-200 blur-3xl opacity-[0.45]" />
        <div className="absolute top-[82%] left-1/2 -translate-x-1/2 w-64 h-64 rounded-full bg-emerald-200 blur-3xl opacity-[0.45]" />
      </div>
